  ...
  return (
    <div className="flex justify-center items-center">
      <textarea
          ...
          className="w-1/2 min-w-96 py-2 px-4 text-sm font-semibold text-green-500 rounded-md shadow-sm text-center resize-none overflow-hidden focus:outline-none focus:ring-0"
          maxLength={2000}
